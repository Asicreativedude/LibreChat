...
const ResetPasswordBodyText = () => {
  ...
  return (
    <div className="flex flex-col space-y-4">
      ...
      <a
        className="inline-flex text-sm font-medium text-text-accent transition-colors hover:underline"
        href={loginPage()}
      >
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <a
          href={loginPage()}
          className="block text-center text-sm font-medium text-text-accent transition-colors hover:underline"
        >
          {localize('com_auth_back_to_login')}
        </a>
      </div>
