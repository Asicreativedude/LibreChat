    ...
    () => [
      ...
      },
      {
        ...
        icon: isPinLoading ? (
          ...
          <Pin className="icon-sm me-2 text-text-primary" aria-hidden="true" />
        ),
      },
      {
      ...
      },
      {
        ...
        icon: <FolderInput className="icon-sm me-2 text-text-primary" aria-hidden="true" />,
        ariaHasPopup: 'dialog' as const,
      ...
      },
      {
        ...
        icon: assignConversationToProject.isLoading ? (
          ...
          <FolderX className="icon-sm me-2 text-text-primary" aria-hidden="true" />
        ),
      },
      {
