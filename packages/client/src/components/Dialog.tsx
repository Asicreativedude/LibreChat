...
const DialogHeader: {
  ...
  <div
    className={cn(
      'flex flex-col space-y-2 border-b border-black/10 p-6 pb-4 text-start dark:border-white/10',
      className ?? '',
    )}
    {...props}
  />
...
const DialogFooter: {
  ...
  <div
    className={cn('flex flex-row justify-between gap-2 px-6 py-4', className ?? '')}
    {...props}
  />
);
